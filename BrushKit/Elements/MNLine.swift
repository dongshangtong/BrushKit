...
public struct MNLine: Codable {
    ...
    public internal(set) var color: MNColor?
    
    public init(begin: CGPoint, end: CGPoint, pointSize: CGFloat, pointStep: CGFloat, color: MNColor?) {
        self.begin = begin
        self.end = end
