...
open class MNPaintingGestureRecognizer: UIPanGestureRecognizer {

    private weak var targetView: UIView!
    
    @discardableResult
    class func addToTarget(_ target: UIView, action: Selector?) -> MNPaintingGestureRecognizer {
        let ges = MNPaintingGestureRecognizer(targetView: target, action: action)
