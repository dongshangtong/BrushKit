...
public struct MNColor: Codable {
    ...
    public static var black = UIColor.black.toMNColor()
    public static var white = UIColor.white.toMNColor()
...
extension UIColor {
    func toMNColor(opacity: CGFloat = 1) -> MNColor {
        var r: CGFloat = 0
        var g: CGFloat = 0
        var b: CGFloat = 0
        var a: CGFloat = 0
        getRed(&r, green: &g, blue: &b, alpha: &a)
        return MNColor(red: Float(r), green: Float(g), blue: Float(b), alpha: Float(a * opacity))
    }
